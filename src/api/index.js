...
export const API_CREATE_STORY_SUCCESS_FAILURE =
  "Stories/API_CREATE_STORY_SUCCESS_FAILURE";
export const API_UPDATE_STORY = "Stories/API_UPDATE_STORY";
export const API_UPDATE_STORY_SUCCESS_FAILURE =
  "Stories/API_UPDATE_STORY_SUCCESS_FAILURE";
export const API_DELETE_STORY = "Stories/API_DELETE_STORY";
export const API_DELETE_STORY_SUCCESS_FAILURE =
  "Stories/API_DELETE_STORY_SUCCESS_FAILURE";
